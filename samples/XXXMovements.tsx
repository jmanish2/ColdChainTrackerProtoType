...
import { Camera, ChevronDown, Clock, Package, FileText, Save, Home, RotateCw, BarChart2, Settings, AlertTriangle, Info, HelpCircle, Printer } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto p-3 pb-24">
        {/* Title */}
        <div className="mb-3">
          <h1 className="text-xl font-bold text-gray-800">Pull Cold Chain Product</h1>
          <p className="text-sm text-gray-600">Track products as they leave refrigeration</p>
        </div>
        ...
        <div className="mb-3">
          <div className="flex items-center">
            ...
            <button className="text-xs text-blue-600">History</button>
          </div>
        </div>
        ...
        <div className="mb-3">
          <div className="flex justify-between items-center mb-1">
            ...
            <button className="flex items-center text-xs text-gray-700 bg-gray-100 px-3 py-1 rounded-full border border-gray-300">
        ...
        <div className="mb-3">
          <div className="flex justify-between items-center mb-1">
            ...
            <button className="text-xs text-blue-600 px-3 py-1 rounded-full border border-blue-600">
              Clear
            </button>
          </div>
...
export default PullProductScreen;